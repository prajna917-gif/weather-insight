...
import os
WEATHER_API_KEY = os.environ.get("WEATHER_API_KEY", "db2c40ce39f3b033326671cb74c1da85")
NEWS_API_KEY = os.environ.get("NEWS_API_KEY", "163ed26700e14946802161eb85a08983")
